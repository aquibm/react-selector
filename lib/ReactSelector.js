...
(function() {
  ...
  ReactSelector = React.createClass({
    ...
    componentDidUpdate: function() {
      if (this.refs.active) {
        return this.refs.active.scrollIntoView(false);
      }
    },
        ...
        items.push(React.DOM.div({
          ...
          onClick: ((function(_this) {
            return function(_item) {
              return function(e) {
                e.stopPropagation();
                return _this._onItemToggle(_item);
              };
            };
          })(this))(item),
    ...
    _processActions: function(event) {
      ...
      if (key === ARROW_DOWN) {
        ...
        if (!active_item && this.props.onItemNotInUniverse) {
          this.props.onItemNotInUniverse(this.state.query);
        }
    ...
    render: function() {
      var containerClicked, filtered_items, filtered_items_section, selected_items;
      ...
      containerClicked = (function(_this) {
        return function(e) {
      ...
      }, this.state.show_filtered_items && this.state.filtered_items_on_top ? filtered_items_section : void 0, React.DOM.div({
        className: "selected"
      }, React.DOM.div({
        className: "container"
